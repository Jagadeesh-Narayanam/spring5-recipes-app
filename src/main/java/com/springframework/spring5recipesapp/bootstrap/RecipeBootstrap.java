package com.springframework.spring5recipesapp.bootstrap;
import com.springframework.spring5recipesapp.domain.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        //get UOMs
        Optional<UnitOfMeasure> eachUomOptional = Optional.ofNullable(unitOfMeasureRepository.findByDescription("Each"));

        if(!eachUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitOfMeasure> tableSpoonUomOptional = Optional.ofNullable(unitOfMeasureRepository.findByDescription("Tablespoon"));

        if(!tableSpoonUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitOfMeasure> teaSpoonUomOptional = Optional.ofNullable(unitOfMeasureRepository.findByDescription("Teaspoon"));

        if(!teaSpoonUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitOfMeasure> dashUomOptional = Optional.ofNullable(unitOfMeasureRepository.findByDescription("Dash"));

        if(!dashUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitOfMeasure> pintUomOptional = Optional.ofNullable(unitOfMeasureRepository.findByDescription("Pint"));

        if(!pintUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitOfMeasure> cupsUomOptional = Optional.ofNullable(unitOfMeasureRepository.findByDescription("Cup"));
        ...
        //get Categories
        Optional<Category> americanCategoryOptional = Optional.ofNullable(categoryRepository.findByDescription("American"));

        if(!americanCategoryOptional.isPresent()){
            throw new RuntimeException("Expected Category Not Found");
        }

        Optional<Category> mexicanCategoryOptional = Optional.ofNullable(categoryRepository.findByDescription("Mexican"));
